...
expect class FirestoreService() {
    ...
    suspend fun updateExpenseList(listId: String, list: ExpenseListDto): Result<Unit>
    ...
    suspend fun addUserToExpenseListMembers(listId: String, userId: String): Result<Unit>

    suspend fun removeUserFromExpenseListMembers(listId: String, userId: String): Result<Unit>

    suspend fun addExpenseListReferenceForUser(userId: String, listId: String): Result<Unit>

    suspend fun removeExpenseListReferenceForUser(userId: String, listId: String): Result<Unit>

    suspend fun getExpensesByListId(listId: String): Result<List<ExpenseDto>>

    suspend fun addExpenseToList(listId: String, expense: ExpenseDto): Result<String>

    suspend fun updateExpenseInList(listId: String, expenseId: String, expense: ExpenseDto): Result<Unit>
