...
sealed class CreateExpenseListUiState {
    ...
    data class Success(val listId: String, val listName: String) : CreateExpenseListUiState()
    data class Error(val message: String) : CreateExpenseListUiState()
}
...
sealed class CreateExpenseListUiEvent {
    data class ListNameChanged(val name: String) : CreateExpenseListUiEvent()
    data class CategoriesSelected(val categoryIds: List<String>) : CreateExpenseListUiEvent()
